...
void TVPExecuteStartupScript() {
    ...
    try {
        ...
        try {
            ...
            spdlog::warn("Startup script '{}' failed, checking for fallback...",
                         TVPStartupScriptName.AsStdString());
#if defined(__ANDROID__)
            __android_log_print(ANDROID_LOG_WARN, "krkr2",
                                "Startup script failed, checking for fallback: system/Initialize.tjs");
#endif
