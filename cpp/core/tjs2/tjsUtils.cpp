...
namespace TJS {
    ...
    void tTJSSpinLock::unlock() { atom_lock.clear(std::memory_order_release); }
    ...
    struct tTJSPointerSizedIntegerBase {
        typedef long type;
    };
    template <>
    struct tTJSPointerSizedIntegerBase<8> {
        typedef tjs_uint64 type;
    };
    template <>
